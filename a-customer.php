...
<head>
    ...
    <title>Expres Bank Customers</title>
...
<div class="row">
   ...
   &nbsp;
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:black;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
        ...
        {
          $user=$_SESSION['user'];
          $result=mysqli_query($conn,"SELECT * FROM customers WHERE name ='$user'");
          while($row=mysqli_fetch_array($result))
          {
            echo "<p><b class='font-weight-bold'>Customer ID</b> &nbsp;: ".$row['customer_id']."</p><br>";
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                ...
                $res = mysqli_query($conn, "SELECT * FROM customers WHERE Name!='$user'");
                ...
                <br><br><br>
                        ...
                        <br><br><br>
                        <button id="transfer"  name="transfer" class="btn btn-outline-dark"" ><b>Transfer</b></button>
                        </form>
        </div>
    </div>
</div>
